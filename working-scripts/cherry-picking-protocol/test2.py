...
with HamiltonInterface(simulate=True) as hammy:
    ...
    hammy.wait_on_response(hammy.send_command(
        ASPIRATE384,
        liquidClass = "Adaptyv_primer_dispensejet_empty",#"50ulTip_conductive_384COREHead_Water_DispenseJet_Empty", #
        aspirateVolume = 30.0,
    ...
    hammy.wait_on_response(hammy.send_command(
        ...
        liquidClass = "Adaptyv_primer_dispensejet_empty",#"50ulTip_conductive_384COREHead_Water_DispenseJet_Empty", #
        dispenseVolume = 30.0,
        dispenseSequence = "cp_tgt_lid_holder_plate"
    ))

    hammy.wait_on_response(hammy.send_command(
        EJECT384,
        # wasteSequence="NTR_384_Primer",
